...
public static class CodeGenerator
{
	...
	/// <summary>Manual trigger from the editor menu.</summary>
	[Menu( "Editor", "Network Storage/Generate Code" )]
	public static void GenerateFromMenu()
	{
		SyncToolConfig.Load();
		var count = Generate();
		Log.Info( $"[NetworkStorage] Code generation complete — {count} files written to {OutputFolder}/" );
	}
